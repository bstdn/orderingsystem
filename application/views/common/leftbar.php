...
<div class="span3">
    <div class="well sidebar-nav">
        <ul class="nav nav-list">
            <li class="nav-header">订单历史TOP5</li>
            <?php if($order_list): ?>
                ...
                <?php endforeach; ?>
            <?php endif; ?>
            <li class="nav-header">热门商家TOP5</li>
            <?php if($business_list): ?>
                <?php foreach($business_list as $v): ?>
                    <li><a class="btn-link copy_business"><?=$v['business_name']?><span class="label label-info"><?=$v['use_num']?></span></a></li>
                <?php endforeach; ?>
            <?php endif; ?>
            <li class="nav-header">热门菜名TOP5</li>
            <?php if($product_list): ?>
                <?php foreach($product_list as $v): ?>
                    <li><a class="btn-link copy_product"><?=$v['product_name']?><span class="label label-important"><?=$v['use_num']?></span></a></li>
                <?php endforeach; ?>
            <?php endif; ?>
        </ul>
    </div><!--/.well -->
